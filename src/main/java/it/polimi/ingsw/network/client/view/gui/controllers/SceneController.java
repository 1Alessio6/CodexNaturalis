...
public abstract class SceneController {
    ...
    /**
     * Initialize the logout button inside the settings.
     *
     * @param settingsPane is the pane in which is contained the logout button
     * @param settingsStage is the stage in which is contained the logout button and the owner of
     *                      the alert generated by it.
     */
    ...
    /**
     * Returns the width of the scene's window.
     *
     * @return the double width value.
     */
    public abstract double getSceneWindowWidth();

    /**
     * Returns the height of the scene's window.
     *
    ...
    /**
     * Generate a StackPane instance containing an error message,
     * that disappear after two seconds.
     *
     * @param details the details of the error.
     * @return the error StackPane.
     */
    ...
    /**
     * Apply a fade transition, with a duration of 1 second to the parameter updatePane.
     *
     * @param updatePane the pane to which apply the FadeTransition.
     */
    ...
    /**
     * Remove the errorPane from the scene main pane after the fade animation ends.
     *
     * @param errorPane the pane to be removed.
     */
    protected abstract void removeUpdatePaneFromMainPane(StackPane errorPane);

    /**
     * Show the error generated before with the method generateError.
     *
     * @param details the details of the error.
     */
