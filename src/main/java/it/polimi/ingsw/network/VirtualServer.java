...
public abstract class VirtualServer implements Remote {
    ...
    public abstract void notifyColor(Color color, Integer clientIndex) throws RemoteException;

    public abstract void notifyRemainingColor(Set<Color> remainingColor) throws RemoteException;
